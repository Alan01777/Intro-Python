...
if peso > 50:
    print('Peso acima do limite! Valor da multa a pagar: R$', (peso - 50) * 4)
else:
    print('Peso dentro do limite. Peso atual:', peso, 'KG. Faltam',
          50 - peso, 'KG. Para atingir o limite!(50KG)')
